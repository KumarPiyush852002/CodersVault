  ...
  return (
    <Router>
      <div className={dark ? "App dark" : "App"}>
        ...
        >
          <a
            href="https://algovine.netlify.app/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Unlock your DSA potential with expertly curated playlists. Learn
            from the best.
          </a>
        </div> */}
        ...
        {questionData.length === 0 ? (
          ...
          <>
            <ThemeContext.Provider value={dark}>
              ...
              />
              {/* <Route path="/learn" children={<Learn></Learn>} /> */}
